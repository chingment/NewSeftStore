    ...
    public class SvUtil
    {
        ...
        public static SvDataJd GetJbfxXlscfx(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                ...
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 220, Max = "∞", Color = CB_1, Tips = "过高" });
            }
        ...
        public static SvDataJd GetJbfxXljsl(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 2.5, Color = CB_1, Tips = "过低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 2.5, Max = 4.6, Color = CB_3, Tips = "偏低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 4.6, Max = 12, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 12, Max = 20, Color = CB_3, Tips = "偏高" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 20, Max = "∞", Color = CB_1, Tips = "过高" });
        ...
        public static SvDataJd GetHxZtahizs(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 5, Color = CB_1, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 5, Max = 15, Color = CB_3, Tips = "轻度" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 15, Max = 30, Color = CB_5, Tips = "中度" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 30, Max = "∞", Color = CB_1, Tips = "重度" });
        ...
        public static SvDataJd GetSmQdsmbl(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 45, Color = CB_3, Tips = "少" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 45, Max = 65, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 65, Max = "∞", Color = CB_3, Tips = "多" });
            }
        ...
        public static SvDataJd GetSmLzcs(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 2, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 2, Max = 4, Color = CB_3, Tips = "偏多" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 4, Max = "∞", Color = CB_1, Tips = "过多" });
            }
        ...
        public static SvDataJd GetSmSmzq(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 3, Color = CB_3, Tips = "少" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 3, Max = 6, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 6, Max = "∞", Color = CB_3, Tips = "多" });
            }
        ...
        public static SvDataJd GetSmTdcs(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 50, Color = CB_3, Tips = "偏少" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 50, Max = 200, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 200, Max = 300, Color = CB_3, Tips = "偏多" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 300, Max = "∞", Color = CB_1, Tips = "过多" });
        ...
        public static SvDataJd GetXlDcjzxl(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 43, Color = CB_1, Tips = "过低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 43, Max = 50, Color = CB_3, Tips = "偏低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 50, Max = 65, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 65, Max = 84, Color = CB_3, Tips = "偏高" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 84, Max = "∞", Color = CB_1, Tips = "过高" });
        ...
        public static SvDataJd GetHxDcjzhx(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 6, Color = CB_1, Tips = "过低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 6, Max = 9, Color = CB_3, Tips = "偏低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 9, Max = 18, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 18, Max = 21, Color = CB_3, Tips = "偏高" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 21, Max = "∞", Color = CB_1, Tips = "过高" });
        ...
        public static SvDataJd GetHxZtcs(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 30, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 30, Max = "∞", Color = CB_3, Tips = "高" });
            }
        ...
        public static SvDataJd GetHrvXzznl(decimal val, decimal jzz, int reportCount, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = var1, Color = CB_1, Tips = "过低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = var1, Max = var2, Color = CB_3, Tips = "偏低" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = var2, Max = var3, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = var3, Max = var4, Color = CB_3, Tips = "偏高" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = var4, Max = "∞", Color = CB_1, Tips = "过高" });
        ...
        public static SvDataJd GetSmSdsmbl(decimal val, bool isGetRefRanges = false, object lastVals = null)
        {
            ...
            if (isGetRefRanges)
            {
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 0, Max = 15, Color = CB_3, Tips = "少" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 15, Max = 25, Color = CB_5, Tips = "正常" });
                jd.RefRanges.Add(new SvDataJd.RefRangeArea { Min = 25, Max = "∞", Color = CB_3, Tips = "多" });
            }
