...
namespace LocalS.Entity
{
    ...
    public enum E_SvHealthReportStatus
    {
        Unknow = 0,
        WaitBuild = 1,
        Building = 2,
    ...
    [Table("SvHealthStageReport")]
    public class SvHealthStageReport
    {
        [Key]
        ...
        public string SmScorePt { get; set; }
        ...
        public string TimeFrameStaPt { get; set; }
