    ...
    public class PayRefundService : BaseService
    {
        ...
        public CustomJsonResult SearchOrder(string operater, string merchId, RupPayRefundSearchOrder rup)
        {
            ...
            var query = (from o in CurrentDb.Order
                         ...
                         o.MerchId == merchId
                         select new { o.Id, o.StoreId, o.StoreName, o.ReceiveMode, o.PayTransId, o.Status, o.PickupIsTrg, o.ExIsHappen, o.ExIsHandle, o.ReceiveModeName, o.MachineId, o.ChargeAmount, o.DiscountAmount, o.OriginalAmount, o.Quantity, o.AppId, o.IsTestMode, o.ClientUserId, o.SubmittedTime, o.ClientUserName, o.Source, o.PayedTime, o.PayWay, o.CreateTime, o.PayStatus, o.PayPartnerPayTransId });
        ...
        public CustomJsonResult Apply(string operater, string merchId, RopPayRefundApply rop)
        {
            ...
            using (TransactionScope ts = new TransactionScope())
            {
                ...
                MqFactory.Global.PushOperateLog(operater, AppId.MERCH, merchId, "PayRefund_Apply", string.Format("订单号:{0}，申请退款金额：{1},提交成功，退款单号：{2}", payRefund.OrderId, payRefund.ApplyAmount.ToF2Price(), payRefund.Id),rop);
