...
namespace WebApiAdmin.Controllers
{
    public class MerchMenuController : OwnApiBaseController
    {
        ...
        {
            IResult result = AdminServiceFactory.SysMenu.InitAdd(this.CurrentUserId, Enumeration.BelongSite.Merch, pId);
            return new OwnApiHttpResponse(result);
        }
        ...
        {
            IResult result = AdminServiceFactory.SysMenu.Add(this.CurrentUserId, Enumeration.BelongSite.Merch, rop);
            return new OwnApiHttpResponse(result);
        }
        ...
        {
            IResult result = AdminServiceFactory.SysMenu.InitEdit(this.CurrentUserId, Enumeration.BelongSite.Merch, id);
            return new OwnApiHttpResponse(result);
        }
        ...
        {
            IResult result = AdminServiceFactory.SysMenu.Edit(this.CurrentUserId, Enumeration.BelongSite.Merch, rop);
            return new OwnApiHttpResponse(result);
        }
        ...
        {
            IResult result = AdminServiceFactory.SysMenu.Sort(this.CurrentUserId, Enumeration.BelongSite.Merch, rop);
            return new OwnApiHttpResponse(result);
        }
    }
}
