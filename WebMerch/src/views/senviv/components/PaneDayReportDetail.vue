  ...
  <div id="day_report_detail" v-loading="loading">
    ...
    <el-row :gutter="12">
      <el-col :span="6" :xs="24" style="margin-bottom:20px">
        ...
        <table v-if="rd!=null&&rd.smSmsc!=null" class="clz" cellspacing="0" cellpadding="0">
          <thead>
            <tr>
              <th>类别</th>
              <th>指标</th>
...
export default {
  ...
  methods: {
    ...
    datetimeFormat2(longTypeDate) {
      const date = new Date(longTypeDate * 1000 - 1000 * 60)
      const y = date.getFullYear()
      let MM = date.getMonth() + 1
      MM = MM < 10 ? ('0' + MM) : MM
      let d = date.getDate()
    ...
    getZxt() {
      ...
      var sm_point_x_min_t = this.datetimeFormat2(this.rd.smPoint.startTime)
          ...
          axisLabel: {
            ...
            rich: {
              ...
              'SC': {
                ...
                height: 100,
                backgroundColor: {
                  image: 'http://file.17fanju.com/Upload/common/spl4.png' // 这个warnImg是上面定义的图片var warnImg = "img/warn.png";
                }
              },
              'RS': {
                verticalAlign: 'bottom',
