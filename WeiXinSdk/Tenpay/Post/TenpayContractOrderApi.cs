...
{
    public class TenpayContractOrderApi : TenpayBasePostApi, ITenpayPostApi
    {
        ...
        public TenpayContractOrderApi(WxAppConfig config, UnifiedOrder order)
        {
            ...
            sParams.Add("contract_appid", config.AppId);//签约公众号
            sParams.Add("contract_mchid", config.PayMchId);//签约商户号
